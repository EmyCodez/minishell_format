...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/13 09:51:40 by esimpson          #+#    #+#             */
/*   Updated: 2024/06/13 10:13:00 by esimpson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

static void	ft_exec_pipe_child(t_node *node, int pfds[2],
		t_ast_direction direction, t_minishell *myshell)
{
	int	status;
